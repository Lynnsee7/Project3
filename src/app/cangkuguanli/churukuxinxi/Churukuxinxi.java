package  app.cangkuguanli.churukuxinxi;
...
public class Churukuxinxi extends BaseFormController {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (flag != null && flag.equals("getJsonStore")) {
                ...
                return toFinish("/WEB-ROOT/app/cangkuguanli/churukuxinxi/churukuxinxi.jsp", resultMap, request,  response);
            }
...
String rukushijianSearch = request.getParameter("rukushijianSearch"); 
 if( rukushijianSearch != null && !rukushijianSearch.equals("") ){  
 	 where.put("rukushijianSearch", rukushijianSearch);  
 } 
String baocuncangkuSearch = request.getParameter("baocuncangkuSearch"); 
 if( baocuncangkuSearch != null && !baocuncangkuSearch.equals("") ){  
 	 where.put("baocuncangkuSearch", baocuncangkuSearch);  
 } 
String chukushijianSearch = request.getParameter("chukushijianSearch"); 
 if( chukushijianSearch != null && !chukushijianSearch.equals("") ){  
 	 where.put("chukushijianSearch", chukushijianSearch);  
 } 
String baocunxiangqingSearch = request.getParameter("baocunxiangqingSearch"); 
 if( baocunxiangqingSearch != null && !baocunxiangqingSearch.equals("") ){  
 	 where.put("baocunxiangqingSearch", baocunxiangqingSearch);  
 } 
String shengchanriqiSearch = request.getParameter("shengchanriqiSearch"); 
 if( shengchanriqiSearch != null && !shengchanriqiSearch.equals("") ){  
 	 where.put("shengchanriqiSearch", shengchanriqiSearch);  
 } 
String baozhiqiSearch = request.getParameter("baozhiqiSearch"); 
 if( baozhiqiSearch != null && !baozhiqiSearch.equals("") ){  
 	 where.put("baozhiqiSearch", baozhiqiSearch);  
 } 
...
String deleteFlagSearch = request.getParameter("deleteFlagSearch"); 
 if( deleteFlagSearch != null && !deleteFlagSearch.equals("") ){  
 	 where.put("deleteFlagSearch", deleteFlagSearch);  
            ...
            String json = IbatisUtil.queryForPage(sqlMap, request, response, where, "Churukuxinxi.selecteList");
    ...
    public ModelAndView doAdd(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            sqlMap.insert("Churukuxinxi.insertObj", where);
	...
	whereMap.put("rukushijian", item.getString("gb2312"));
}
else if (i == 2) {
	whereMap.put("baocuncangku", item.getString("gb2312"));
}
else if (i == 3) {
	whereMap.put("chukushijian", item.getString("gb2312"));
}
else if (i == 4) {
	whereMap.put("baocunxiangqing", item.getString("gb2312"));
}
else if (i == 5) {
	whereMap.put("shengchanriqi", item.getString("gb2312"));
}
else if (i == 6) {
	whereMap.put("baozhiqi", item.getString("gb2312"));
}
else if (i == 7) {
	whereMap.put("detail", item.getString("gb2312"));
		    ...
		    sqlMap.insert("Churukuxinxi.insertObj", whereMap);
    ...
    public ModelAndView doUpdate(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            sqlMap.update("Churukuxinxi.updateObj", where);
	...
	whereMap.put("detail", item.getString("gb2312"));
			...
			whereMap.put("id", id);
		    sqlMap.update("Churukuxinxi.updateObj", whereMap);
    ...
    public ModelAndView doDeleOrUnDele(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Churukuxinxi.doDeleOrUnDele", where);
     ...
     public ModelAndView doShenPi(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Churukuxinxi.doShenPi", where);
    ...
    public static ModelAndView doExportExcel(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			// 根据查询条件得到结果集
			HashMap<String, Object> where = new HashMap<String, Object>();
			List<Object> listInfo = sqlMap.queryForList("Churukuxinxi.selecteList", where);
 ...
 ws.addCell(label_0); 
 Label label_1 = new Label(2, 3, "入库时间", wcfFC5);  
 ws.addCell(label_1); 
 Label label_2 = new Label(3, 3, "保存仓库", wcfFC5);  
 ws.addCell(label_2); 
 Label label_3 = new Label(4, 3, "出库时间", wcfFC5);  
 ws.addCell(label_3); 
 Label label_4 = new Label(5, 3, "保存详情", wcfFC5);  
 ws.addCell(label_4); 
 Label label_5 = new Label(6, 3, "生产日期", wcfFC5);  
 ws.addCell(label_5); 
 Label label_6 = new Label(7, 3, "保质期", wcfFC5);  
 ws.addCell(label_6); 
 ...
 ws.addCell(label_9); 
		...
		// 表体
		for (int i = 0; i < al.size(); i++) { String huohao = ((HashMap) (al.get(i))).get("huohao").toString();  
 label_0 = new Label(1, i + 4, huohao, wcfF4); 
 ws.addCell(label_0); 
 String rukushijian = ((HashMap) (al.get(i))).get("rukushijian").toString();  
 label_1 = new Label(2, i + 4, rukushijian, wcfF4); 
 ws.addCell(label_1); 
 String baocuncangku = ((HashMap) (al.get(i))).get("baocuncangku").toString();  
 label_2 = new Label(3, i + 4, baocuncangku, wcfF4); 
 ws.addCell(label_2); 
 String chukushijian = ((HashMap) (al.get(i))).get("chukushijian").toString();  
 label_3 = new Label(4, i + 4, chukushijian, wcfF4); 
 ws.addCell(label_3); 
 String baocunxiangqing = ((HashMap) (al.get(i))).get("baocunxiangqing").toString();  
 label_4 = new Label(5, i + 4, baocunxiangqing, wcfF4); 
 ws.addCell(label_4); 
 String shengchanriqi = ((HashMap) (al.get(i))).get("shengchanriqi").toString();  
 label_5 = new Label(6, i + 4, shengchanriqi, wcfF4); 
 ws.addCell(label_5); 
 String baozhiqi = ((HashMap) (al.get(i))).get("baozhiqi").toString();  
 label_6 = new Label(7, i + 4, baozhiqi, wcfF4); 
 ws.addCell(label_6); 
