package  app.cangkuguanli.cangkuxinxi;
...
public class Cangkuxinxi extends BaseFormController {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (flag != null && flag.equals("getJsonStore")) {
                ...
                return toFinish("/WEB-ROOT/app/cangkuguanli/cangkuxinxi/cangkuxinxi.jsp", resultMap, request,  response);
            }
    ...
    public ModelAndView doGetJsonStore(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String cangkumingchengSearch = request.getParameter("cangkumingchengSearch"); 
 if( cangkumingchengSearch != null && !cangkumingchengSearch.equals("") ){  
 	 where.put("cangkumingchengSearch", cangkumingchengSearch);  
 } 
String xiujianshijianSearch = request.getParameter("xiujianshijianSearch"); 
 if( xiujianshijianSearch != null && !xiujianshijianSearch.equals("") ){  
 	 where.put("xiujianshijianSearch", xiujianshijianSearch);  
 } 
String rongjiSearch = request.getParameter("rongjiSearch"); 
 if( rongjiSearch != null && !rongjiSearch.equals("") ){  
 	 where.put("rongjiSearch", rongjiSearch);  
 } 
String shiyonglvSearch = request.getParameter("shiyonglvSearch"); 
 if( shiyonglvSearch != null && !shiyonglvSearch.equals("") ){  
 	 where.put("shiyonglvSearch", shiyonglvSearch);  
 } 
String suozaiweizhiSearch = request.getParameter("suozaiweizhiSearch"); 
 if( suozaiweizhiSearch != null && !suozaiweizhiSearch.equals("") ){  
 	 where.put("suozaiweizhiSearch", suozaiweizhiSearch);  
 } 
String xiangguanpeizhiSearch = request.getParameter("xiangguanpeizhiSearch"); 
 if( xiangguanpeizhiSearch != null && !xiangguanpeizhiSearch.equals("") ){  
 	 where.put("xiangguanpeizhiSearch", xiangguanpeizhiSearch);  
 } 
...
if( SysInfo.getLoginUserType(request, response).equals("2") ){ 
	   where.put("dataRight",  "  operatorId='"+SysInfo.getLoginUserId(request, response)+"' " );
}

            }
            
            String json = IbatisUtil.queryForPage(sqlMap, request, response, where, "Cangkuxinxi.selecteList");
    ...
    public ModelAndView doAdd(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            String cangkumingcheng = request.getParameter("cangkumingcheng"); 
where.put("cangkumingcheng", cangkumingcheng);  
String xiujianshijian = request.getParameter("xiujianshijian"); 
where.put("xiujianshijian", xiujianshijian);  
String rongji = request.getParameter("rongji"); 
where.put("rongji", rongji);  
String shiyonglv = request.getParameter("shiyonglv"); 
where.put("shiyonglv", shiyonglv);  
String suozaiweizhi = request.getParameter("suozaiweizhi"); 
where.put("suozaiweizhi", suozaiweizhi);  
String xiangguanpeizhi = request.getParameter("xiangguanpeizhi"); 
where.put("xiangguanpeizhi", xiangguanpeizhi);  
String detail = request.getParameter("detail"); 
where.put("detail", detail);  

            
            sqlMap.insert("Cangkuxinxi.insertObj", where);
    ...
    public ModelAndView doAddWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
		    ...
		    sqlMap.insert("Cangkuxinxi.insertObj", whereMap);
...
where.put("detail", detail);  
            ...
            sqlMap.update("Cangkuxinxi.updateObj", where);
    ...
    public ModelAndView doUpdateWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			whereMap.put("id", id);
		    sqlMap.update("Cangkuxinxi.updateObj", whereMap);
    ...
    public ModelAndView doDeleOrUnDele(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Cangkuxinxi.doDeleOrUnDele", where);
     ...
     public ModelAndView doShenPi(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Cangkuxinxi.doShenPi", where);
...
if( SysInfo.getLoginUserType(request, response).equals("2") ){ 
    ...
    public static ModelAndView doExportExcel(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			// 根据查询条件得到结果集
			HashMap<String, Object> where = new HashMap<String, Object>();
			List<Object> listInfo = sqlMap.queryForList("Cangkuxinxi.selecteList", where);
	...
	public static WritableSheet refreashSheet(List<Object> al, WritableSheet ws) throws Exception {
		...
		// 表头(列号,行号 ,内容 )
		 Label label_0 = new Label(1, 3, "仓库名称", wcfFC5);  
 ws.addCell(label_0); 
 Label label_1 = new Label(2, 3, "修建时间", wcfFC5);  
 ws.addCell(label_1); 
 Label label_2 = new Label(3, 3, "容积", wcfFC5);  
 ws.addCell(label_2); 
 Label label_3 = new Label(4, 3, "使用率", wcfFC5);  
 ws.addCell(label_3); 
 Label label_4 = new Label(5, 3, "所在位置", wcfFC5);  
 ws.addCell(label_4); 
 Label label_5 = new Label(6, 3, "相关配置", wcfFC5);  
 ws.addCell(label_5); 
 ...
 ws.addCell(label_8); 
		...
		// 表体
		for (int i = 0; i < al.size(); i++) { String cangkumingcheng = ((HashMap) (al.get(i))).get("cangkumingcheng").toString();  
 label_0 = new Label(1, i + 4, cangkumingcheng, wcfF4); 
 ws.addCell(label_0); 
 String xiujianshijian = ((HashMap) (al.get(i))).get("xiujianshijian").toString();  
 label_1 = new Label(2, i + 4, xiujianshijian, wcfF4); 
 ws.addCell(label_1); 
 String rongji = ((HashMap) (al.get(i))).get("rongji").toString();  
 label_2 = new Label(3, i + 4, rongji, wcfF4); 
 ws.addCell(label_2); 
 String shiyonglv = ((HashMap) (al.get(i))).get("shiyonglv").toString();  
 label_3 = new Label(4, i + 4, shiyonglv, wcfF4); 
 ws.addCell(label_3); 
 String suozaiweizhi = ((HashMap) (al.get(i))).get("suozaiweizhi").toString();  
 label_4 = new Label(5, i + 4, suozaiweizhi, wcfF4); 
 ws.addCell(label_4); 
 String xiangguanpeizhi = ((HashMap) (al.get(i))).get("xiangguanpeizhi").toString();  
 label_5 = new Label(6, i + 4, xiangguanpeizhi, wcfF4); 
 ws.addCell(label_5); 
