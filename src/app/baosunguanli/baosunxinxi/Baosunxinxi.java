package  app.baosunguanli.baosunxinxi;
...
public class Baosunxinxi extends BaseFormController {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (flag != null && flag.equals("getJsonStore")) {
                ...
                return toFinish("/WEB-ROOT/app/baosunguanli/baosunxinxi/baosunxinxi.jsp", resultMap, request,  response);
            }
...
String baosunriqiSearch = request.getParameter("baosunriqiSearch"); 
 if( baosunriqiSearch != null && !baosunriqiSearch.equals("") ){  
 	 where.put("baosunriqiSearch", baosunriqiSearch);  
 } 
String baosunshuomingSearch = request.getParameter("baosunshuomingSearch"); 
 if( baosunshuomingSearch != null && !baosunshuomingSearch.equals("") ){  
 	 where.put("baosunshuomingSearch", baosunshuomingSearch);  
 } 
...
if( SysInfo.getLoginUserType(request, response).equals("2") ){ 
	   where.put("dataRight",  "  operatorId='"+SysInfo.getLoginUserId(request, response)+"' " );
            ...
            String json = IbatisUtil.queryForPage(sqlMap, request, response, where, "Baosunxinxi.selecteList");
...
String baosunriqi = request.getParameter("baosunriqi"); 
where.put("baosunriqi", baosunriqi);  
String baosunshuoming = request.getParameter("baosunshuoming"); 
where.put("baosunshuoming", baosunshuoming);  
String detail = request.getParameter("detail"); 
where.put("detail", detail);  

            
            sqlMap.insert("Baosunxinxi.insertObj", where);
    ...
    public ModelAndView doAddWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
		    ...
		    sqlMap.insert("Baosunxinxi.insertObj", whereMap);
...
where.put("detail", detail);  
            ...
            sqlMap.update("Baosunxinxi.updateObj", where);
    ...
    public ModelAndView doUpdateWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			whereMap.put("id", id);
		    sqlMap.update("Baosunxinxi.updateObj", whereMap);
    ...
    public ModelAndView doDeleOrUnDele(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Baosunxinxi.doDeleOrUnDele", where);
     ...
     public ModelAndView doShenPi(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Baosunxinxi.doShenPi", where);
...
if( SysInfo.getLoginUserType(request, response).equals("2") ){ 
    ...
    public static ModelAndView doExportExcel(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			// 根据查询条件得到结果集
			HashMap<String, Object> where = new HashMap<String, Object>();
			List<Object> listInfo = sqlMap.queryForList("Baosunxinxi.selecteList", where);
 ...
 ws.addCell(label_0); 
 Label label_1 = new Label(2, 3, "报损日期", wcfFC5);  
 ws.addCell(label_1); 
 Label label_2 = new Label(3, 3, "报损说明", wcfFC5);  
 ws.addCell(label_2); 
 ...
 ws.addCell(label_0); 
 String baosunriqi = ((HashMap) (al.get(i))).get("baosunriqi").toString();  
 label_1 = new Label(2, i + 4, baosunriqi, wcfF4); 
 ws.addCell(label_1); 
 String baosunshuoming = ((HashMap) (al.get(i))).get("baosunshuoming").toString();  
 label_2 = new Label(3, i + 4, baosunshuoming, wcfF4); 
 ws.addCell(label_2); 
