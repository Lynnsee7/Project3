package app.renliziyuanguanli.neibuyuangongguanli;
...
public class Neibuyuangongguanli extends BaseFormController {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (flag != null && flag.equals("getJsonStore")) {
				...
				return toFinish("/WEB-ROOT/app/renliziyuanguanli/neibuyuangongguanli/neibuyuangongguanli.jsp", resultMap, request, response);
			}
	...
	public ModelAndView doGetJsonStore(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			String yuangongxingmingSearch = request.getParameter("yuangongxingmingSearch");
			if (yuangongxingmingSearch != null && !yuangongxingmingSearch.equals("")) {
				where.put("yuangongxingmingSearch", yuangongxingmingSearch);
			}
			String yuangonggonghaoSearch = request.getParameter("yuangonggonghaoSearch");
			if (yuangonggonghaoSearch != null && !yuangonggonghaoSearch.equals("")) {
				where.put("yuangonggonghaoSearch", yuangonggonghaoSearch);
			}
			...
			String jiatingzhuzhiSearch = request.getParameter("jiatingzhuzhiSearch");
			if (jiatingzhuzhiSearch != null && !jiatingzhuzhiSearch.equals("")) {
				where.put("jiatingzhuzhiSearch", jiatingzhuzhiSearch);
			}
			...
			String json = IbatisUtil.queryForPage(sqlMap, request, response, where, "Neibuyuangongguanli.selecteList");
	...
	public ModelAndView doAdd(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			String yuangongxingming = request.getParameter("yuangongxingming");
			where.put("yuangongxingming", yuangongxingming);
			String yuangonggonghao = request.getParameter("yuangonggonghao");
			where.put("yuangonggonghao", yuangonggonghao);
			String ruzhishijian = request.getParameter("ruzhishijian");
			where.put("ruzhishijian", ruzhishijian);
			String jiatingzhuzhi = request.getParameter("jiatingzhuzhi");
			where.put("jiatingzhuzhi", jiatingzhuzhi);
			...
			sqlMap.insert("Neibuyuangongguanli.insertObj", where);
	...
	public ModelAndView doAddWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			sqlMap.insert("Neibuyuangongguanli.insertObj", whereMap);
	...
	public ModelAndView doUpdate(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			sqlMap.update("Neibuyuangongguanli.updateObj", where);
	...
	public ModelAndView doUpdateWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			whereMap.put("id", id);
			sqlMap.update("Neibuyuangongguanli.updateObj", whereMap);
	...
	public ModelAndView doDeleOrUnDele(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			where.put("id", id);
			sqlMap.delete("Neibuyuangongguanli.doDeleOrUnDele", where);
	...
	public ModelAndView doShenPi(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			where.put("id", id);
			sqlMap.delete("Neibuyuangongguanli.doShenPi", where);
	...
	public static ModelAndView doExportExcel(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			// 根据查询条件得到结果集
			HashMap<String, Object> where = new HashMap<String, Object>();
			List<Object> listInfo = sqlMap.queryForList("Neibuyuangongguanli.selecteList", where);
	...
	public static WritableSheet refreashSheet(List<Object> al, WritableSheet ws) throws Exception {
		...
		// 表头(列号,行号 ,内容 )
		Label label_0 = new Label(1, 3, "员工姓名", wcfFC5);
		ws.addCell(label_0);
		Label label_1 = new Label(2, 3, "员工工号", wcfFC5);
		ws.addCell(label_1);
		Label label_2 = new Label(3, 3, "入职时间", wcfFC5);
		ws.addCell(label_2);
		Label label_3 = new Label(4, 3, "家庭住址", wcfFC5);
		ws.addCell(label_3);
		...
		for (int i = 0; i < al.size(); i++) {
			String yuangongxingming = ((HashMap) (al.get(i))).get("yuangongxingming").toString();
			label_0 = new Label(1, i + 4, yuangongxingming, wcfF4);
			ws.addCell(label_0);
			String yuangonggonghao = ((HashMap) (al.get(i))).get("yuangonggonghao").toString();
			label_1 = new Label(2, i + 4, yuangonggonghao, wcfF4);
			ws.addCell(label_1);
			String ruzhishijian = ((HashMap) (al.get(i))).get("ruzhishijian").toString();
			label_2 = new Label(3, i + 4, ruzhishijian, wcfF4);
			ws.addCell(label_2);
			String jiatingzhuzhi = ((HashMap) (al.get(i))).get("jiatingzhuzhi").toString();
			label_3 = new Label(4, i + 4, jiatingzhuzhi, wcfF4);
			ws.addCell(label_3);
