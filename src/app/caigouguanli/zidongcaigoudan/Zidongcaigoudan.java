package  app.caigouguanli.zidongcaigoudan;
...
public class Zidongcaigoudan extends BaseFormController {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (flag != null && flag.equals("getJsonStore")) {
                ...
                return toFinish("/WEB-ROOT/app/caigouguanli/zidongcaigoudan/zidongcaigoudan.jsp", resultMap, request,  response);
            }
...
String deleteFlagSearch = request.getParameter("deleteFlagSearch"); 
 if( deleteFlagSearch != null && !deleteFlagSearch.equals("") ){  
 	 where.put("deleteFlagSearch", deleteFlagSearch);  
            ...
            String json = IbatisUtil.queryForPage(sqlMap, request, response, where, "Zidongcaigoudan.selecteList");
    ...
    public ModelAndView doAdd(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            String shangpinmingcheng = request.getParameter("shangpinmingcheng"); 
where.put("shangpinmingcheng", shangpinmingcheng);  
String huohao = request.getParameter("huohao"); 
where.put("huohao", huohao);  
String shangpinleixing = request.getParameter("shangpinleixingHidd"); 
where.put("shangpinleixing", shangpinleixing);  
String gongyingshang = request.getParameter("gongyingshangHidd"); 
where.put("gongyingshang", gongyingshang);  
String chengyunshang = request.getParameter("chengyunshangHidd"); 
where.put("chengyunshang", chengyunshang);  
String danjia = request.getParameter("danjia"); 
where.put("danjia", danjia);  
String caigouriqi = request.getParameter("caigouriqi"); 
where.put("caigouriqi", caigouriqi);  
String caigouren = request.getParameter("caigouren"); 
where.put("caigouren", caigouren);  
String shuliang = request.getParameter("shuliang"); 
where.put("shuliang", shuliang);  
String kucunliang = request.getParameter("kucunliang"); 
where.put("kucunliang", kucunliang);  
String detail = request.getParameter("detail"); 
where.put("detail", detail);  

            
            sqlMap.insert("Zidongcaigoudan.insertObj", where);
    ...
    public ModelAndView doAddWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
		    ...
		    sqlMap.insert("Zidongcaigoudan.insertObj", whereMap);
...
where.put("detail", detail);  
            ...
            sqlMap.update("Zidongcaigoudan.updateObj", where);
    ...
    public ModelAndView doUpdateWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			whereMap.put("id", id);
		    sqlMap.update("Zidongcaigoudan.updateObj", whereMap);
    ...
    public ModelAndView doDeleOrUnDele(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Zidongcaigoudan.doDeleOrUnDele", where);
     ...
     public ModelAndView doShenPi(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Zidongcaigoudan.doShenPi", where);
    ...
    public static ModelAndView doExportExcel(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			// 根据查询条件得到结果集
			HashMap<String, Object> where = new HashMap<String, Object>();
			List<Object> listInfo = sqlMap.queryForList("Zidongcaigoudan.selecteList", where);
 ...
 ws.addCell(label_9); 
 Label label_10 = new Label(11, 3, "Id", wcfFC5);  
 ws.addCell(label_10); 
 Label label_11 = new Label(12, 3, "创建时间", wcfFC5);  
 ws.addCell(label_11); 
 Label label_12 = new Label(13, 3, "备注", wcfFC5);  
 ws.addCell(label_12); 


		// 表体
		for (int i = 0; i < al.size(); i++) { String shangpinmingcheng = ((HashMap) (al.get(i))).get("shangpinmingcheng").toString();  
 ...
 label_10 = new Label(11, i + 4, id, wcfF4); 
 ws.addCell(label_10); 
 String itime = ((HashMap) (al.get(i))).get("itime").toString();  
 label_11 = new Label(12, i + 4, itime, wcfF4); 
 ws.addCell(label_11); 
 String detail = ((HashMap) (al.get(i))).get("detail").toString();  
 label_12 = new Label(13, i + 4, detail, wcfF4); 
 ws.addCell(label_12); 
 } 
