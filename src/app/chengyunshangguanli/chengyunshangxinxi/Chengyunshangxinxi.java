package  app.chengyunshangguanli.chengyunshangxinxi;
...
public class Chengyunshangxinxi extends BaseFormController {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (flag != null && flag.equals("getJsonStore")) {
                ...
                return toFinish("/WEB-ROOT/app/chengyunshangguanli/chengyunshangxinxi/chengyunshangxinxi.jsp", resultMap, request,  response);
            }
    ...
    public ModelAndView doGetJsonStore(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String chengyunshangmingchengSearch = request.getParameter("chengyunshangmingchengSearch"); 
 if( chengyunshangmingchengSearch != null && !chengyunshangmingchengSearch.equals("") ){  
 	 where.put("chengyunshangmingchengSearch", chengyunshangmingchengSearch);  
 } 
String chengyunleixingSearch = request.getParameter("chengyunleixingSearch"); 
 if( chengyunleixingSearch != null && !chengyunleixingSearch.equals("") ){  
 	 where.put("chengyunleixingSearch", chengyunleixingSearch);  
 } 
String chexingSearch = request.getParameter("chexingSearch"); 
 if( chexingSearch != null && !chexingSearch.equals("") ){  
 	 where.put("chexingSearch", chexingSearch);  
 } 
...
String deleteFlagSearch = request.getParameter("deleteFlagSearch"); 
 if( deleteFlagSearch != null && !deleteFlagSearch.equals("") ){  
 	 where.put("deleteFlagSearch", deleteFlagSearch);  
            ...
            String json = IbatisUtil.queryForPage(sqlMap, request, response, where, "Chengyunshangxinxi.selecteList");
    ...
    public ModelAndView doAdd(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            String chengyunshangmingcheng = request.getParameter("chengyunshangmingcheng"); 
where.put("chengyunshangmingcheng", chengyunshangmingcheng);  
String chengyunleixing = request.getParameter("chengyunleixing"); 
where.put("chengyunleixing", chengyunleixing);  
String chexing = request.getParameter("chexing"); 
where.put("chexing", chexing);  
...
where.put("detail", detail);  
            ...
            sqlMap.insert("Chengyunshangxinxi.insertObj", where);
    ...
    public ModelAndView doAddWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
		    ...
		    sqlMap.insert("Chengyunshangxinxi.insertObj", whereMap);
...
where.put("detail", detail);  
            ...
            sqlMap.update("Chengyunshangxinxi.updateObj", where);
    ...
    public ModelAndView doUpdateWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			whereMap.put("id", id);
		    sqlMap.update("Chengyunshangxinxi.updateObj", whereMap);
    ...
    public ModelAndView doDeleOrUnDele(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Chengyunshangxinxi.doDeleOrUnDele", where);
     ...
     public ModelAndView doShenPi(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Chengyunshangxinxi.doShenPi", where);
    ...
    public static ModelAndView doExportExcel(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			// 根据查询条件得到结果集
			HashMap<String, Object> where = new HashMap<String, Object>();
			List<Object> listInfo = sqlMap.queryForList("Chengyunshangxinxi.selecteList", where);
	...
	public static WritableSheet refreashSheet(List<Object> al, WritableSheet ws) throws Exception {
		...
		// 表头(列号,行号 ,内容 )
		 Label label_0 = new Label(1, 3, "承运商名称", wcfFC5);  
 ws.addCell(label_0); 
 Label label_1 = new Label(2, 3, "承运类型", wcfFC5);  
 ws.addCell(label_1); 
 Label label_2 = new Label(3, 3, "车型", wcfFC5);  
 ws.addCell(label_2); 
 Label label_3 = new Label(4, 3, "地址", wcfFC5);  
 ws.addCell(label_3); 
 Label label_4 = new Label(5, 3, "联系人", wcfFC5);  
 ws.addCell(label_4); 
 Label label_5 = new Label(6, 3, "联系电话", wcfFC5);  
 ws.addCell(label_5); 
 ...
 ws.addCell(label_8); 
		...
		// 表体
		for (int i = 0; i < al.size(); i++) { String chengyunshangmingcheng = ((HashMap) (al.get(i))).get("chengyunshangmingcheng").toString();  
 label_0 = new Label(1, i + 4, chengyunshangmingcheng, wcfF4); 
 ws.addCell(label_0); 
 String chengyunleixing = ((HashMap) (al.get(i))).get("chengyunleixing").toString();  
 label_1 = new Label(2, i + 4, chengyunleixing, wcfF4); 
 ws.addCell(label_1); 
 String chexing = ((HashMap) (al.get(i))).get("chexing").toString();  
 label_2 = new Label(3, i + 4, chexing, wcfF4); 
 ws.addCell(label_2); 
 String dizhi = ((HashMap) (al.get(i))).get("dizhi").toString();  
 label_3 = new Label(4, i + 4, dizhi, wcfF4); 
 ws.addCell(label_3); 
 String lianxiren = ((HashMap) (al.get(i))).get("lianxiren").toString();  
 label_4 = new Label(5, i + 4, lianxiren, wcfF4); 
 ws.addCell(label_4); 
 String lianxidianhua = ((HashMap) (al.get(i))).get("lianxidianhua").toString();  
 label_5 = new Label(6, i + 4, lianxidianhua, wcfF4); 
 ws.addCell(label_5); 
