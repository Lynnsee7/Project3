package  app.jibencanshu.shangpinleixing;
...
public class Shangpinleixing extends BaseFormController {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (flag != null && flag.equals("getJsonStore")) {
                ...
                return toFinish("/WEB-ROOT/app/jibencanshu/shangpinleixing/shangpinleixing.jsp", resultMap, request,  response);
            }
...
String deleteFlagSearch = request.getParameter("deleteFlagSearch"); 
 if( deleteFlagSearch != null && !deleteFlagSearch.equals("") ){  
 	 where.put("deleteFlagSearch", deleteFlagSearch);  
            ...
            String json = IbatisUtil.queryForPage(sqlMap, request, response, where, "Shangpinleixing.selecteList");
    ...
    public ModelAndView doAdd(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            String shangpinleixing = request.getParameter("shangpinleixing"); 
where.put("shangpinleixing", shangpinleixing);  
String detail = request.getParameter("detail"); 
where.put("detail", detail);  

            
            sqlMap.insert("Shangpinleixing.insertObj", where);
    ...
    public ModelAndView doAddWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
		    ...
		    sqlMap.insert("Shangpinleixing.insertObj", whereMap);
...
where.put("detail", detail);  
            ...
            sqlMap.update("Shangpinleixing.updateObj", where);
    ...
    public ModelAndView doUpdateWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			whereMap.put("id", id);
		    sqlMap.update("Shangpinleixing.updateObj", whereMap);
    ...
    public ModelAndView doDeleOrUnDele(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Shangpinleixing.doDeleOrUnDele", where);
     ...
     public ModelAndView doShenPi(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            where.put("id", id);
            sqlMap.delete("Shangpinleixing.doShenPi", where);
    ...
    public static ModelAndView doExportExcel(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			// 根据查询条件得到结果集
			HashMap<String, Object> where = new HashMap<String, Object>();
			List<Object> listInfo = sqlMap.queryForList("Shangpinleixing.selecteList", where);
	...
	public static WritableSheet refreashSheet(List<Object> al, WritableSheet ws) throws Exception {
		...
		// 表头(列号,行号 ,内容 )
		 Label label_0 = new Label(1, 3, "商品类型", wcfFC5);  
 ws.addCell(label_0); 
 ...
 ws.addCell(label_3); 
		...
		// 表体
		for (int i = 0; i < al.size(); i++) { String shangpinleixing = ((HashMap) (al.get(i))).get("shangpinleixing").toString();  
 label_0 = new Label(1, i + 4, shangpinleixing, wcfF4); 
 ws.addCell(label_0); 
