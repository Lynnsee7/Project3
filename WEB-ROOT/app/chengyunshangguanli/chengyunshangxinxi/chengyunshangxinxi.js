				...
				items: [
					{
						...
						xtype: 'textfield',
						fieldLabel: '承运商名称',
						name: 'chengyunshangmingchengSearch',
						id: 'chengyunshangmingchengSearch',
						anchor: '100%'
					}]
			}
				,
				...
				items: [
					{
						...
						xtype: 'textfield',
						fieldLabel: '承运类型',
						name: 'chengyunleixingSearch',
						id: 'chengyunleixingSearch',
						anchor: '100%'
					}]
			}
				,
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore({
		...
		remoteSort: true,
		fields: ['chengyunshangmingcheng', 'chengyunleixing', 'chexing', 'dizhi', 'lianxiren', 'lianxidianhua', 'id', 'itime', 'detail', 'deleteFlag'],
		proxy: new Ext.data.HttpProxy({
			url: '/WEB-ROOT/app/chengyunshangguanli/chengyunshangxinxi.do',
			method: 'POST'
		}),
		baseParams: {
			flag: 'getJsonStore',
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel({
		...
		bbar: pagingBar,
		columns: [ {
				header: '<font color="blue">承运商名称</font>',
				width: 60,
				align: 'center',
				sortable: true,
				dataIndex: 'chengyunshangmingcheng'
			}
			, {
				header: '<font color="blue">承运类型</font>',
				width: 60,
				align: 'center',
				sortable: true,
				dataIndex: 'chengyunleixing'
			}
			, {
				header: '<font color="blue">车型</font>',
				width: 60,
				align: 'center',
				sortable: true,
				dataIndex: 'chexing'
			...
			, {
				header: '<font color="blue">地址</font>',
				width: 60,
				align: 'center',
				sortable: true,
				dataIndex: 'dizhi'
			...
			, {
				header: '<font color="blue">联系人</font>',
				width: 60,
				align: 'center',
				sortable: true,
				dataIndex: 'lianxiren'
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.chengyunshangmingchengSearch = document.all.chengyunshangmingchengSearch.value;
	ManageObj.dataStore.baseParams.chengyunleixingSearch = document.all.chengyunleixingSearch.value;
	ManageObj.dataStore.baseParams.chexingSearch = document.all.chexingSearch.value;
	ManageObj.dataStore.baseParams.dizhiSearch = document.all.dizhiSearch.value;
	ManageObj.dataStore.baseParams.lianxirenSearch = document.all.lianxirenSearch.value;
...
ManageObj.getOperationFormPan = function(rowIndex, flag) {
	ManageObj.operationFormPan = new Ext.FormPanel({
		...
		items: [{
			...
			items: [{
				...
				items: [{
					xtype: 'textfield',
					fieldLabel: '<font color="red">*</font>&nbsp;&nbsp;承运商名称',
					name: 'chengyunshangmingcheng',
					id: 'chengyunshangmingcheng',
					anchor: '95%',
					allowBlank: false
				}]
			}
				...
				items: [{
					xtype: 'textfield',
					fieldLabel: '<font color="red">*</font>&nbsp;&nbsp;承运类型',
					name: 'chengyunleixing',
					id: 'chengyunleixing',
					anchor: '95%',
					allowBlank: false
				}]
				...
				items: [{
					xtype: 'textfield',
					fieldLabel: '<font color="red">*</font>&nbsp;&nbsp;车型',
					name: 'chexing',
					id: 'chexing',
					anchor: '95%',
					allowBlank: false
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('chengyunshangmingcheng').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('chengyunshangmingcheng');
		ManageObj.operationFormPan.findById('chengyunleixing').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('chengyunleixing');
		ManageObj.operationFormPan.findById('chexing').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('chexing');
		ManageObj.operationFormPan.findById('dizhi').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('dizhi');
		ManageObj.operationFormPan.findById('lianxiren').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('lianxiren');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/chengyunshangguanli/chengyunshangxinxi.do?flag=doExportExcel";
	window.open(url);
};
