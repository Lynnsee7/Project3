ManageObj.doAdd = function() {
	...
	var x = ManageObj.addWindow.getPosition( false )[0] ;
	var y = Math.floor( ( RIGHT_SIDE_PAGE_HEIGHT - ManageObj.addWindow.getHeight() ) / 2 ) ;
	ManageObj.addWindow.setPosition( x , y );
}
...
ManageObj.doAddSubmit = function() {
	...
	ManageObj.operationFormPan.getForm().submit({
		waitMsg : '数据提交中......',
		method : 'post',
		url : '/WEB-ROOT/app/chengyunshangguanli/chengyunshangxinxi.do?flag=doAddSubmit',
