...
url : '/WEB-ROOT/app/caigouguanli/zidongcaigoudan.do',
baseParams : {
flag : 'doGuanLian',
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		totalProperty : 'totalProperty',
		remoteSort : true,
		fields : [ 'shangpinmingcheng','huohao','shangpinleixing','gongyingshang','chengyunshang','danjia','caigouriqi','caigouren','shuliang','kucunliang','id','itime','detail','deleteFlag' ],
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/caigouguanli/zidongcaigoudan.do?flag=doExportExcel";
	window.open(  url );
};
