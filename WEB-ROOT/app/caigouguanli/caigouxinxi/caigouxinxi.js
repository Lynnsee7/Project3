var ManageObj = function() {
	...
	ManageObj.shangpinleixingGuanLianStore = new Ext.data.JsonStore({
		url : '/WEB-ROOT/app/caigouguanli/caigouxinxi.do',
		baseParams : {
			flag : 'doGuanLian',
			guanLianBiao : 'shangpinleixing',
			guanLianZiDuan : 'shangpinleixing'
		},
		root : 'root',
		totalProperty : 'totalProperty',
		fields : [ 'shangpinleixing' ]
	});

	ManageObj.gongyingshangGuanLianStore = new Ext.data.JsonStore({
		url : '/WEB-ROOT/app/caigouguanli/caigouxinxi.do',
		baseParams : {
			flag : 'doGuanLian',
			guanLianBiao : 'gongyingshangxinxi',
			guanLianZiDuan : 'gongyingshangmingcheng'
		},
		root : 'root',
		totalProperty : 'totalProperty',
		fields : [ 'gongyingshangmingcheng' ]
	});

	ManageObj.chengyunshangGuanLianStore = new Ext.data.JsonStore({
		url : '/WEB-ROOT/app/caigouguanli/caigouxinxi.do',
		baseParams : {
			flag : 'doGuanLian',
			guanLianBiao : 'chengyunshangxinxi',
			guanLianZiDuan : 'chengyunshangmingcheng'
		},
		root : 'root',
		totalProperty : 'totalProperty',
		fields : [ 'chengyunshangmingcheng' ]
	});
					...
					items : [
						{
							...
							xtype : 'textfield',
							fieldLabel : '商品类型',
							name : 'shangpinleixingSearch',
							id : 'shangpinleixingSearch',
							anchor : '100%'
						}, {
							xtype : 'textfield',
							fieldLabel : '供应商',
							name : 'gongyingshangSearch',
							id : 'gongyingshangSearch',
							anchor : '100%'
						} ]
				}
				,
					...
					items : [
						{
							xtype : 'textfield',
							fieldLabel : '承运商',
							name : 'chengyunshangSearch',
							id : 'chengyunshangSearch',
							anchor : '100%'
						}, {
							xtype : 'textfield',
							fieldLabel : '采购单价',
					...
					items : [
						{
							xtype : 'textfield',
							fieldLabel : '库存量',
							name : 'kucunliangSearch',
							id : 'kucunliangSearch',
							anchor : '100%'
						}, {
							xtype : 'textfield',
							fieldLabel : '审批状态',
							name : 'zhuangtaiSearch',
							id : 'zhuangtaiSearch',
							anchor : '100%'
						} ]
				}
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore({
		...
		totalProperty : 'totalProperty',
		remoteSort : true,
		fields : [ 'shangpinmingcheng', 'huohao', 'shangpinleixing', 'gongyingshang', 'chengyunshang', 'danjia', 'caigouriqi', 'caigouren', 'shuliang', 'kucunliang', 'zhuangtai', 'id', 'itime', 'detail', 'deleteFlag', 'fuJian' ],
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel({
		...
		columns : [ {
			...
			, {
				header : '<font color="blue">承运商</font>',
				width : 60,
				align : 'center',
				sortable : true,
				dataIndex : 'chengyunshang',
				hidden : true
			}
			, {
				header : '<font color="blue">采购单价</font>',
				width : 60,
				align : 'center',
				sortable : true,
				dataIndex : 'danjia'
			...
			, {
				header : '<font color="blue">采购日期</font>',
				width : 60,
				align : 'center',
				sortable : true,
			...
			, {
				header : '<font color="blue">采购人</font>',
				width : 60,
				align : 'center',
				sortable : true,
				dataIndex : 'caigouren',
			...
			, {
				header : '<font color="blue">采购量</font>',
				width : 60,
				align : 'center',
				sortable : true,
				dataIndex : 'shuliang'
			...
			, {
				...
				align : 'center',
				sortable : true,
				renderer : ManageObj.kclRenderer,
...
ManageObj.kclRenderer = function(id, cellmeta, record, rowIndex, columnIndex, store) {
	var returnStr = "";
	if (record.data['kucunliang'] <= 100) {
		returnStr += "<font color='red'>" + record.data['kucunliang'] + "（库存不足）</font>";
	} else {
		returnStr += "" + record.data['kucunliang'] + "";
	}
	return returnStr;
}
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.shangpinleixingSearch = document.all.shangpinleixingSearch.value;
	ManageObj.dataStore.baseParams.gongyingshangSearch = document.all.gongyingshangSearch.value;
	ManageObj.dataStore.baseParams.chengyunshangSearch = document.all.chengyunshangSearch.value;
	ManageObj.dataStore.baseParams.danjiaSearch = document.all.danjiaSearch.value;
	ManageObj.dataStore.baseParams.caigouriqiSearch = document.all.caigouriqiSearch.value;
	ManageObj.dataStore.baseParams.caigourenSearch = document.all.caigourenSearch.value;
	ManageObj.dataStore.baseParams.shuliangSearch = document.all.shuliangSearch.value;
	ManageObj.dataStore.baseParams.kucunliangSearch = document.all.kucunliangSearch.value;
	ManageObj.dataStore.baseParams.zhuangtaiSearch = document.all.zhuangtaiSearch.value;
...
ManageObj.getOperationFormPan = function(rowIndex, flag) {
		...
		items : [ {
			...
			items : [ {
				...
				, {
					...
					items : [ {
						xtype : 'combo',
						fieldLabel : '<font color="red">*</font>&nbsp;商品类型',
						store : ManageObj.shangpinleixingGuanLianStore,
						valueField : 'shangpinleixing',
						displayField : 'shangpinleixing',
						mode : 'remote',
						forceSelection : true,
						hiddenName : 'shangpinleixingHidd',
						triggerAction : 'all',
						editable : false,
				...
				, {
					...
					items : [ {
						...
						store : ManageObj.gongyingshangGuanLianStore,
						valueField : 'gongyingshangmingcheng',
						displayField : 'gongyingshangmingcheng',
						mode : 'remote',
						forceSelection : true,
						hiddenName : 'gongyingshangHidd',
						triggerAction : 'all',
						editable : false,
						name : 'gongyingshang',
						id : 'gongyingshang',
				...
				, {
					...
					items : [ {
						xtype : 'combo',
						fieldLabel : '<font color="red">*</font>&nbsp;承运商',
						store : ManageObj.chengyunshangGuanLianStore,
						valueField : 'chengyunshangmingcheng',
						displayField : 'chengyunshangmingcheng',
						mode : 'remote',
						forceSelection : true,
						hiddenName : 'chengyunshangHidd',
						triggerAction : 'all',
						editable : false,
						name : 'chengyunshang',
						id : 'chengyunshang',
				...
				, {
					...
					items : [ {
						xtype : 'datefield',
						format : 'Y-m-d',
						fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;采购日期',
						name : 'caigouriqi',
						id : 'caigouriqi',
						anchor : '95%',
						allowBlank : false
				...
				, {
					...
					items : [ {
						xtype : 'textfield',
						fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;采购人',
						name : 'caigouren',
						id : 'caigouren',
						anchor : '95%',
						allowBlank : false
				...
				, {
					...
					items : [ {
						xtype : 'textfield',
						fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;采购量',
						name : 'shuliang',
						id : 'shuliang',
						anchor : '95%',
						allowBlank : false
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('shangpinmingcheng').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('shangpinmingcheng');
		ManageObj.operationFormPan.findById('huohao').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('huohao');
		ManageObj.operationFormPan.findById('shangpinleixing').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('shangpinleixing');
		ManageObj.operationFormPan.findById('gongyingshang').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('gongyingshang');
		ManageObj.operationFormPan.findById('chengyunshang').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('chengyunshang');
		ManageObj.operationFormPan.findById('danjia').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('danjia');
		ManageObj.operationFormPan.findById('caigouriqi').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('caigouriqi');
		ManageObj.operationFormPan.findById('caigouren').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('caigouren');
		ManageObj.operationFormPan.findById('shuliang').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('shuliang');
		ManageObj.operationFormPan.findById('kucunliang').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('kucunliang');
		ManageObj.operationFormPan.findById('zhuangtai').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('zhuangtai');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/caigouguanli/caigouxinxi.do?flag=doExportExcel";
	window.open(url);
};
