				...
				items: [
					{
						...
						xtype: 'textfield',
						fieldLabel: '仓库名称',
						name: 'cangkumingchengSearch',
						id: 'cangkumingchengSearch',
						anchor: '100%'
					}]
			}
				,
				...
				items: [
					{
						...
						format: 'Y-m-d',
						fieldLabel: '修建时间',
						name: 'xiujianshijianSearch',
						id: 'xiujianshijianSearch',
						anchor: '100%'
					}]
			}
				,
				...
				items: [
					{
						xtype: 'textfield',
						fieldLabel: '所在位置',
						name: 'suozaiweizhiSearch',
						id: 'suozaiweizhiSearch',
						anchor: '100%'
					}]
			}
				,
				...
				items: [
					{
						xtype: 'textfield',
						fieldLabel: '相关配置',
						name: 'xiangguanpeizhiSearch',
						id: 'xiangguanpeizhiSearch',
						anchor: '100%'
					}]
			}
			]
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore({
		...
		remoteSort: true,
		fields: ['cangkumingcheng', 'xiujianshijian', 'rongji', 'shiyonglv', 'suozaiweizhi', 'xiangguanpeizhi', 'id', 'itime', 'detail', 'deleteFlag'],
		proxy: new Ext.data.HttpProxy({
			url: '/WEB-ROOT/app/cangkuguanli/cangkuxinxi.do',
			method: 'POST'
		}),
		baseParams: {
			flag: 'getJsonStore',
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel({
		...
		bbar: pagingBar,
		columns: [{
				header: '<font color="blue">仓库名称</font>',
				width: 60,
				align: 'center',
				sortable: true,
			...
			, {
				header: '<font color="blue">修建时间</font>',
				width: 60,
				align: 'center',
				sortable: true,
				dataIndex: 'xiujianshijian'
			}
			, {
				header: '<font color="blue">容积</font>',
				width: 60,
				align: 'center',
				sortable: true,
				dataIndex: 'rongji'
			...
			, {
				header: '<font color="blue">使用率</font>',
				width: 60,
				align: 'center',
				sortable: true,
				dataIndex: 'shiyonglv'
			...
			, {
				header: '<font color="blue">所在位置</font>',
				width: 60,
				align: 'center',
				sortable: true,
				dataIndex: 'suozaiweizhi'
			}
			, {
				header: '<font color="blue">相关配置</font>',
				width: 60,
				align: 'center',
				sortable: true,
				dataIndex: 'xiangguanpeizhi'
			}
			, {
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.cangkumingchengSearch = document.all.cangkumingchengSearch.value;
	ManageObj.dataStore.baseParams.xiujianshijianSearch = document.all.xiujianshijianSearch.value;
	ManageObj.dataStore.baseParams.rongjiSearch = document.all.rongjiSearch.value;
	ManageObj.dataStore.baseParams.shiyonglvSearch = document.all.shiyonglvSearch.value;
	ManageObj.dataStore.baseParams.suozaiweizhiSearch = document.all.suozaiweizhiSearch.value;
	ManageObj.dataStore.baseParams.xiangguanpeizhiSearch = document.all.xiangguanpeizhiSearch.value;
...
ManageObj.getOperationFormPan = function(rowIndex, flag) {
		...
		items: [{
			...
			items: [{
				...
				items: [{
					xtype: 'datefield',
					format: 'Y-m-d',
					fieldLabel: '<font color="red">*</font>&nbsp;&nbsp;修建时间',
					name: 'xiujianshijian',
					id: 'xiujianshijian',
					anchor: '95%',
					allowBlank: false
				...
				items: [{
					xtype: 'textfield',
					fieldLabel: '<font color="red">*</font>&nbsp;&nbsp;容积',
					name: 'rongji',
					id: 'rongji',
					anchor: '95%',
					allowBlank: false
				...
				items: [{
					xtype: 'textfield',
					fieldLabel: '<font color="red">*</font>&nbsp;&nbsp;使用率',
					name: 'shiyonglv',
					id: 'shiyonglv',
					anchor: '95%',
					allowBlank: false
				...
				items: [{
					xtype: 'textfield',
					fieldLabel: '<font color="red">*</font>&nbsp;&nbsp;相关配置',
					name: 'xiangguanpeizhi',
					id: 'xiangguanpeizhi',
					anchor: '95%',
					allowBlank: false
				}]
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('cangkumingcheng').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('cangkumingcheng');
		ManageObj.operationFormPan.findById('xiujianshijian').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('xiujianshijian');
		ManageObj.operationFormPan.findById('rongji').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('rongji');
		ManageObj.operationFormPan.findById('shiyonglv').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('shiyonglv');
		ManageObj.operationFormPan.findById('suozaiweizhi').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('suozaiweizhi');
		ManageObj.operationFormPan.findById('xiangguanpeizhi').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('xiangguanpeizhi');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/cangkuguanli/cangkuxinxi.do?flag=doExportExcel";
	window.open(url);
};
