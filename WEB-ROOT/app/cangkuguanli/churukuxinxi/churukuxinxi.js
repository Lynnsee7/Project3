...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel({
		...
		columns: [{
			...
			, {
				header: '<font color="blue">入库时间</font>',
				width: 60,
				align: 'center',
				sortable: true,
			...
			, {
				header: '<font color="blue">保存仓库</font>',
				width: 60,
				align: 'center',
				sortable: true,
			...
			, {
				header: '<font color="blue">出库时间</font>',
				width: 60,
				align: 'center',
				sortable: true,
			...
			, {
				header: '<font color="blue">保存详情</font>',
				width: 60,
				align: 'center',
				sortable: true,
			...
			, {
				header: '<font color="blue">生产日期</font>',
				width: 60,
				align: 'center',
				sortable: true,
			...
			, {
				header: '<font color="blue">保质期</font>',
				width: 60,
				align: 'center',
				sortable: true,
				dataIndex: 'baozhiqi'
		...
		items: [{
			...
			items: [{
				...
				items: [{
					xtype: 'datefield',
					format: 'Y-m-d',
					fieldLabel: '<font color="red">*</font>&nbsp;&nbsp;入库时间',
					name: 'rukushijian',
					id: 'rukushijian',
					anchor: '95%',
					allowBlank: false
				...
				items: [{
					xtype: 'combo',
					fieldLabel: '<font color="red">*</font>&nbsp;保存仓库',
				...
				items: [{
					xtype: 'datefield',
					format: 'Y-m-d',
					fieldLabel: '<font color="red">*</font>&nbsp;&nbsp;生产日期',
					name: 'shengchanriqi',
					id: 'shengchanriqi',
					anchor: '95%',
					allowBlank: false
				...
				items: [{
					xtype: 'datefield',
					format: 'Y-m-d',
					fieldLabel: '<font color="red">*</font>&nbsp;&nbsp;保质期',
					name: 'baozhiqi',
					id: 'baozhiqi',
					anchor: '95%',
					allowBlank: false
