...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore({
		...
		remoteSort : true,
		fields : [ 'huiyuanmingcheng', 'huiyuanbianhao', 'lianxidianhua', 'id', 'itime', 'detail', 'deleteFlag', 'fuJian' ],
		proxy : new Ext.data.HttpProxy({
			url : '/WEB-ROOT/app/huiyuanguanli/huiyuanxinxi.do',
			method : 'POST'
		}),
		baseParams : {
			flag : 'getJsonStore',
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/huiyuanguanli/huiyuanxinxi.do?flag=doExportExcel";
	window.open(url);
};
