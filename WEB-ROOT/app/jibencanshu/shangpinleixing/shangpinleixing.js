...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore({
		...
		remoteSort: true,
		fields: ['shangpinleixing', 'id', 'itime', 'detail', 'deleteFlag'],
		proxy: new Ext.data.HttpProxy({
			url: '/WEB-ROOT/app/jibencanshu/shangpinleixing.do',
			method: 'POST'
		}),
		baseParams: {
			flag: 'getJsonStore',
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/jibencanshu/shangpinleixing.do?flag=doExportExcel";
	window.open(url);
};
